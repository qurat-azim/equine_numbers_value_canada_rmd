...
The R programming language and the following R packages were used to perform the analysis: knitr and tidyverse [@key1]. The code used to perform the analysis and create this report can be found here: https://github.com/ttimbers/equine_numbers_value_canada_rmd.
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Fig: Horses per province", fig.align='center'}
